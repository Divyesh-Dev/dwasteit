...
<div id="menu-wrapper">
	<div id="menu">
		<ul>
			<li class="current_page_item"><a href="index.html"4>Homepage</a></li>
			<li class="current_page_item"><a href="login.php">Login</a></li>
			<li><a href="giver_cl.php">Sign in as Giver</a></li>
...
<div id="wrapper"> 
	...
	<div id="page">
		...
		<div id="content">
          ...
          <form name="taker" action="taker_cl.php" method="post">
        <center>
            <table width="330" height="360">
                <Caption><h1>Sign up as Taker!!</h1>
                <p>&nbsp;</p>
                </Caption>
                <tr>
