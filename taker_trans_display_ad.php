...
<title>Taker Transaction Report | dwasteit </title>
	<link rel = "icon" href = 
...
<div id="menu-wrapper">
	<div id="menu">
		<ul>
			...
			<li><a href="taker_ad.php">taker</a></li>
			<li><a href="taker_trans_ad.php">taker Trans</a></li>
	...
	<div id="page">
		<div><img src="images/box giving.png" width="609" height="363" alt="" />
			...
			<ul>
				...
				<li>
					<h2>Reports</h2>
					<ul>
						<li><a href="giver_display_ad.php">Giver</a></li>
						<li><a href="giver_trans_display_ad.php">Giver Transaction</a></li>
						<li><a href="taker_display_ad.php">Taker&nbsp;</a></li>
						<li><a href="taker_trans_display_ad.php">Taker Transaction</a></li>
					</ul>
				</li>
			</ul>
		</div>
		...
		<div id="content">
			<div class="post">
				...
				<form name="taker_trans_display" action="taker_trans_display_ad.php" method="post">
					<center>
						<h1>&nbsp;</h1>
					  <h1>Taker Trans. Info. Admin Report</h1>
						<p>&nbsp;</p>
						<p>
