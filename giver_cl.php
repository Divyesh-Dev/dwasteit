...
<div id="menu-wrapper">
  <div id="menu">
    <ul>
      ...
      <li><a href="taker_cl.php">Sign in as Taker</a></li>
      ...
      <div id="sidebar">
        <ul>
          ...
          <li>
            ...
            <ul>
              <li>&emsp;&emsp;&emsp;<a href="giver_display.php">Giver</a></li>
    ...
    <div id="content">
      <div class="post">
        ...
        if ( isset( $_POST[ 'sbm' ] ) ) {
          ...
          if ( $sb == "Submit" ) {
            if ( $fl == 0 ) {
              $sql = "insert into giver values('$_POST[givid]', '$_POST[name]', '$_POST[addr]', 
                        '$_POST[city]','$_POST[cont_no]','$_POST[email_id]', '$_POST[password]',
                        '$_POST[occupation]')";
            ...
            $sql = "update giver set name='$_POST[name]', addr='$_POST[addr]',city='$_POST[city]', 
                cont_no ='$_POST[cont_no]', email_id='$_POST[email_id]', password='$_POST[password]', 
                occupation='$_POST[occupation]' where givid='$_POST[givid]'";
            mysql_query( $sql, $connects );
            echo "data updated..";
          } else if ( $sb == "Delete" ) {
            $sql = "delete from giver where givid='$_POST[givid]'";
            mysql_query( $sql, $connects );
