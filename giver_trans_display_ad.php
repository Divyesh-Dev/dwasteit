...
<title>Giver Transaction  Report | dwasteit </title>
	<link rel = "icon" href = 
	...
	<div id="page">
		...
		<div id="content">
			<div class="post">
   			 ...
   			 <form name="giver_trans_display" action="giver_trans_display_ad.php" method="post">
					<center>
						<h1>&nbsp;</h1>
					  <h1>Giver Trans Admin Report</h1>
						<p>&nbsp;</p>
						<p>
