...
<div id="menu-wrapper">
  <div id="menu">
    <ul>
      <li class="current_page_item"><a href="index_gr.html">Homepage</a></li>
...
<div id="wrapper"> 
  ...
  <div id="page">
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              ...
              <li>&emsp;&emsp;&emsp;<a href="giver_trans_cl.php">make a giver transaction</a></li>
   ...
   <form name="giver_trans" action="giver_trans_cl.php" method="post">
          <center>
            <table width="354" height="285">
              <br>
              <br>
              <Caption>
              <h1>Giver Transaction Information</h1>
              <p>&nbsp;</p>
              </Caption>
              <tr>
