...
<div id="menu-wrapper">
	<div id="menu">
		<ul>
			...
			<li><a href="taker_trans_cl.php">Taker Trans</a></li>
	...
	<div id="page">
		...
		<div id="content">
			<div class="post">
				...
				<form name="taker_trans_display" action="taker_trans_display.php" method="post">
					<center>
						<h1>&nbsp;</h1>
					  <h1>Taker Transaction Information Report</h1>
						<p>&nbsp;</p>
						<p>
