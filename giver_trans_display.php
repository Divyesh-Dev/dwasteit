...
<div id="menu-wrapper">
	<div id="menu">
		<ul>
			...
			<li><a href="giver_trans_cl.php">Giver Trans</a></li>
	...
	<div id="page">
		<div><img src="images/box giving.png" width="609" height="363" alt="" />
			...
			<ul>
				...
				<li>
					<h2>Reports</h2>
					<ul>
						<li><a href="giver_display.php">Giver</a></li>
				...
				<li>
					...
					<ul>
						...
						<li><a href="giver_trans_cl.php">Make a giver transaction</a></li>
					</ul>
				</li>
			</ul>
		</div>
		...
		<div id="content">
			<div class="post">
   			 ...
   			 <form name="giver_trans_display" action="giver_trans_display.php" method="post">
					<center>
						<h1>&nbsp;</h1>
					  <h1>Giver Transaction Information Report</h1>
						<p>&nbsp;</p>
						<p>
